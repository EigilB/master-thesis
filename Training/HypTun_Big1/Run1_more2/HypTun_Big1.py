...
past_models_dir2 = '/zhome/13/e/97883/Documents/Speciale_code/Results/HypTun_Big1/Run1_more/'
Result_dir = '/zhome/13/e/97883/Documents/Speciale_code/Results/HypTun_Big1/Run1_more2/'
...
model = keras.models.load_model(past_models_dir2+'best_acc'+str(par_number))
...
hyperparameters = np.zeros((1, 12))
hyperparameters[0, :] = np.array([batch_size, alpha, decay, l2, nl, n1, n2, n3, n4, n5, score, acc])
np.savetxt(Result_dir+'RandomSearch'+str(par_number)+'.csv', CSV, delimiter=",", header="batch_size,alpha,decay,l2,nl,n1,n2,n3,n4,n5,score,accuracies")
